...
const serviceNames = ['events', 'workshops', 'dances', 'ballrooms', 'users', 'files', 'documents', 'volunteers', 'eventVolunteers', 'eventRoles', 'eventVolunteerAssignments', 'formationDiagrams'] as const
