...
export function GlobalSpinner({ loading, loadingMessage, timeout, connectionTimeoutMessage }: GlobalSpinnerProps) {
  ...
  return <div className={className}>
    <div className={classNames(
      ...
      <img alt={loadingMessage} className="h-15 sepia-50" src="/loading.gif" />
