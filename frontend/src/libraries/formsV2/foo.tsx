...
export default function Foo() {
  const [value, onChange] = useState<Data>({a: '', b: '', l: [{_id: '1', value: ''}, {_id: '2', value: ''}], l2: [{_id: '3', value: ''}, {_id: '4', value: ''}]})
  return <Form value={value} onChange={onChange}>
    ...
    <ListField<L, unknown, L, Data> path="l"
      component={
    ...
    />
    ---
    <ListField<L, unknown, L, Data> path="l2"
      component={
        ({value, onChange}: {value: L, onChange: (l: L) => unknown}) =>
          <input type="text" value={value.value} onChange={e => onChange({ ...value, value: e.target.value})} />
      }
